...
{
    Wektor3D tmp = Orientacja * PozycjaSrodka; // Orientacja * PozycjaSrodka
    Wektor3D X (A,0,0);
    Wektor3D Y (0,B,0);
    Wektor3D Z (0,0,C);
    (*this).ustaw_orientacja_wektor(X);
    (*this).ustaw_orientacja_wektor(Y);
    (*this).ustaw_orientacja_wektor(Z);
    wspolrzedne[0] = Odniesienie + tmp; //PozycjaSrodka
    wspolrzedne[1] = Odniesienie + tmp - X;
    wspolrzedne[2] = Odniesienie + tmp - X - Y;
    wspolrzedne[3] = Odniesienie + tmp - Y;
    wspolrzedne[4] = Odniesienie + tmp - Z;
    wspolrzedne[5] = Odniesienie + tmp - X - Z;
    wspolrzedne[6] = Odniesienie + tmp - X - Y - Z;
    wspolrzedne[7] = Odniesienie + tmp - Y - Z;
}
